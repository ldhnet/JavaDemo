...
import org.ldh.redis.conf.jedisService;
...
@SpringBootTest
@Slf4j
public class RedisConcurrentTests {
    //总库存
    ...
    private  jedisService jedisUitil = new jedisService();
    ...
    private String qiang(String b) {
        ...
        while ((startTime + timeout) >= System.currentTimeMillis()) {
            ...
            if (jedisUitil.setnx(shangpingKey, b)) {
                //用户b拿到锁
                log.info("用户{}拿到锁...", b);
                try {
                    //商品是否剩余
                ...
                if (b.equals("神牛-1") || b.equals("神牛-2")) {
                    log.info("用户{}等待获取锁...", b);
                }
            }
        }
